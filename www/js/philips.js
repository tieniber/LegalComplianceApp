document.addEventListener("deviceready", function() {
    ...
    waitForDojoConfig(function(){
        overrideOfflineSync();
        window.dojoConfig.server.timeout = 300000; //Server timeout increased to 5 minutes to sync all the articles data for the first time
...
function overrideOfflineSync(){
    ...
    window.dojoConfig.store.createStoreFn = function(){
    ...
    // Open files in system browser. /publicfile is a custom request handler
...
{
    var t=(obj);
    window.localStorage.setItem("lblclicked",t.innerText);			
}
